...
class ConfmgtControllerRev1ewForm extends ConfmgtController
{
	...
	public function edit()
	{
		...
		$this->setRedirect(JRoute::_('index.php?option=com_confmgt&view=rev1ew&layout=edit', false));
	}
	...
	public function remove()
	{
		...
		if ($data === false) {
			...
			// Redirect back to the edit screen.
			$id = (int) $app->getUserState('com_confmgt.edit.rev1ew.id');
			$this->setRedirect(JRoute::_('index.php?option=com_confmgt&view=rev1ew&layout=edit&id='.$id, false));
			return false;
		}
