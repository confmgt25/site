 ...
 */
class ConfmgtControllerCamerareadypaper extends ConfmgtController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Camerareadypaper', 'ConfmgtModel');
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_confmgt&view=camerareadypaperform&layout=edit', false));
    }
