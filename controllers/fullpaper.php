 ...
 */
class ConfmgtControllerFullpaper extends ConfmgtController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Fullpaper', 'ConfmgtModel');
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_confmgt&view=fullpaperform&layout=edit', false));
    }
    ...
    public function publish() {
        ...
        if ($return === false) {
            ...
            $app->setUserState('com_confmgt.edit.bid.id', null);
