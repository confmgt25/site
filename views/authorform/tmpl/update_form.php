...
<div class = 'form-horizontal well'>
  <fieldset>
    <div class="author-edit front-end-edit">
      ...
      <?php endif; ?>
      <form id="form-author" role="form" action="<?php echo JRoute::_('index.php?option=com_confmgt'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            ...
            <?php echo JText::_('or'); ?> <a href="<?php echo JRoute::_('index.php?option=com_confmgt&task=authorform.update_cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
