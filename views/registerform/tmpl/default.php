...
<div class="register-edit front-end-edit">
    ...
    <form id="form-register" action="<?php echo JRoute::_('index.php?option=com_confmgt&task=register.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_confmgt&task=registerform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_confmgt" />
            <input type="hidden" name="task" value="registerform.save" />
