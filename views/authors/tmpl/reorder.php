...
<thead>
<tr>
<th width="25%"><?php echo JText::_("COM_CONFMGT_AUTHOR_NUMBER"); ?></th>
<th width="75%"><?php echo JText::_("COM_CONFMGT_NAME"); ?></th>
</tr>
</thead>
<tbody>
        ...
        <?php $ordering	= true; ?>
				<?php //TO-DO change the default ACL to confmgt ACL 
						...
						?>
                        <tr>
                        	<td class = "order"><input type="hidden" id="cb<?php echo $i; ?> " name="cid[]" value="<?php echo $item->id; ?>" /><input type="text" name="order[]" size="5" value="<?php echo $item->ordering;?>" class="text-area-order" /> 
                            </td>
                            <td>
...
<button class="btn btn-default btn-lg" type="submit"><?php echo 'Save authors sequence'; ?> </button>
</form>	
