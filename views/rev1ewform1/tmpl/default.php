...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-rev1ew').submit(function(event){
...
<div class="rev1ew-edit front-end-edit">
    ...
    <form id="form-rev1ew" action="<?php echo JRoute::_('index.php?option=com_confmgt&task=rev1ew.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_confmgt&task=rev1ewform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
