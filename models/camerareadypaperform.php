...
class ConfmgtModelCamerareadypaperForm extends JModelForm
{
	...
	public function getTable($type = 'Camerareadypaper', $prefix = 'ConfmgtTable', $config = array())
	{   
	...
	{
		// Get the form.
		$form = $this->loadForm('com_confmgt.camerareadypaper', 'camerareadypaperform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
