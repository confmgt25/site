 ...
 * Confmgt model.
 */
class ConfmgtModelRegisterForm extends JModelForm
{
	...
	protected function populateState()
	{
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_confmgt.edit.register.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_confmgt.edit.register.id', $id);
        }
	...
	public function getTable($type = 'Register', $prefix = 'ConfmgtTable', $config = array())
	{   
	...
	{
		// Get the form.
		$form = $this->loadForm('com_confmgt.register', 'registerform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	{
		$data = JFactory::getApplication()->getUserState('com_confmgt.edit.register.data', array());
        if (empty($data)) {
            $data = $this->getData();
        }
	...
	{
		$id = (!empty($data['id'])) ? $data['id'] : (int)$this->getState('register.id');
